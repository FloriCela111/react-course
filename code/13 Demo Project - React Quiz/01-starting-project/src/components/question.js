export default [
    {
        id: 'q1',
        text: 'Wich of the following definitions best describes React.js?',
        answers: [
            'A library to build user interfaces with help of declarative code.',
            'A library for managing state in web applications.',
            'A framework to build user interfaces with help of imperative code.',
            'A library used for building moblie applications only.',
        ],
    },
    {
        id: 'q2',
    ...
    {
        id: 'q3',
        text: 'Can you indetify what JSX is?',
        answers: [
            'A JavaScript extension that adds HTML-like syntax to JavaScript.',
            'A JavaSript library for building dynamic user interfaces.',
    ...
    {
        id: 'q7',
        text: 'Wich approach can NOT be used to render content conditionally',
        answers: [
            'Using a the #if template synatax.',
